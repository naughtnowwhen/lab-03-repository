...
let ourFriendlyBeastsA : IhornedBeast[] = [];
let ourFriendlyBeastsB : IhornedBeast[] = [];
let keywordsA : unknown[] = [];
let keywordsB : unknown[] = [];

type whichDataSet = "set-a" | "set-a";


interface IhornedBeast {
    image_url : string;
    title : string;
    description : string;
    keyword : string;
    horns : number;  
    whichDataSet? : "set-a" | "set-a";
}

function HornMaker(this : IhornedBeast, rawData : IhornedBeast, whichDataSet : whichDataSet) {  
  this.image_url = rawData.image_url;
  this.title = rawData.title;
  this.description = rawData.description;
  this.keyword = rawData.keyword;
  this.horns = rawData.horns;
